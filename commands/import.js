            ...
            request
                ...
                .on('response', function(response) {
                    if (response.statusCode == 200) 
                        return message.reply("You have successfully added **" + params[1] + "** to the queue!");
                    else
                        return message.reply("Uh oh! Something went wrong adding to the queue, please try again later!");
                });
        });
    }
}